...
class KNearestNeighbour:
    ...
    def _find_closest_kclasses_(self, newx):
        ...
        temp_k = self.k
        closest_k = self._check_dups_(sorted_combined_list, temp_k)
        return [i[1] for i in closest_k]

    # Get most frequent element in k-range list
    def get_class(self, xtest):
        closest_list = self._find_closest_kclasses_(xtest)
...
if __name__ == "__main__":
    ...
    a = KNearestNeighbour(x1, y1, 2)
    print(str(a.accuracy(x2, y2)) + "%")
